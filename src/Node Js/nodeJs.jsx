...
const NodeJsMainPage = () => {
    return (
        <div className='NodeJs'>
            ...
            <p className='NodeJs-p'>Our team is currently working on improving this service. Please check back soon; it will be available shortly. Thank you for your patience!</p>
