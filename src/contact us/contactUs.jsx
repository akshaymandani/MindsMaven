      ...
      <div className='cu-right'>
        ...
        <div className='cu-right-content'>
          <form onSubmit={handleSubmit}>
            ...
            <input type="text" name="name" id="name" placeholder='Akshay Mandani' value={formData.name} onChange={handleChange} required /><br />
            <label htmlFor="phone">Phone Number</label><br />
            <input type="tel" name="phone" id="phone" placeholder='+91 884 949 2570' value={formData.phone} onChange={handleChange} required /><br />
            <label htmlFor="email">Email</label><br />
            <input type="email" name="email" id="email" placeholder='akshay@gmail.com' value={formData.email} onChange={handleChange} required /><br />
